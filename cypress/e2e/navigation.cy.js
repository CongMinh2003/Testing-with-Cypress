...
//   it('TC-08', () => nav.clickHeader(1, '/contact'));
//   it('TC-09', () => nav.clickHeader(2, '/calendar'));
//   it('TC-10', () => nav.clickHeader(3, '/phonebook'));

//   it('TC-11', () =>
//     nav.clickExternal('.list-inline > :nth-child(4) > a', 'eoffice.qnu.edu.vn')
//   );

//   it('TC-12', () => nav.clickMainMenu(1, '/'));
//   it('TC-13', () => nav.clickMainMenu(2, '/vi/philosophy-of-education'));
//   it('TC-14', () => nav.clickMainMenu(3, '/vi/academics-admissions'));
//   it('TC-15', () => nav.clickMainMenu(4, '/students'));
//   it('TC-16', () => nav.clickMainMenu(5, '/vi/international-cooperations'));
//   it('TC-17', () => nav.clickMainMenu(6, '/research'));
//   it('TC-18', () => nav.clickMainMenu(7, '/vi/qnu-life-events'));
//   it('TC-19', () => nav.clickMainMenu(8, '/vi/news-review'));
